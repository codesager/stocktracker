...
const StockTracker = () => {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 font-sans text-sm ${isDark ? 'dark bg-gray-900' : 'bg-gray-100'} flex`}>
      <Sidebar
      ...
      <div className="flex-1 flex flex-col min-h-screen overflow-hidden">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    ...
                    className={`px-3 py-1 rounded-lg flex items-center transition-colors text-sm ${autoRefreshEnabled
                  ...
                  <button
                    ...
                    disabled={isRefreshing && currentPage === 'home'}
                  >
                    <RefreshCw className={`mr-1 ${(isRefreshing && currentPage === 'home') ? 'animate-spin' : ''}`} size={14} />
                    Refresh
                  </button>
                  {currentPage === 'home' && (
                    <button
        ...
        <div className="flex-1 overflow-y-auto">
          {currentPage === 'home' ? (
            <div className="w-full px-2 sm:px-4 lg:px-6 py-6 flex flex-col xl:flex-row gap-6 items-start">
              <main className={`flex-1 w-full grid ${selectedLayout} gap-4`}>
              ...
              {/* Chart Panel */}
              {selectedStockSymbol && (
                <div className="w-full xl:w-[500px] 2xl:w-[700px] shrink-0">
                  <ChartPanel
